...
internal static class Locations
{
    ...
    {
        modelBuilder.Entity<Country>().HasData(Countries().OrderBy(c => c.Name, StringComparer.OrdinalIgnoreCase));
        modelBuilder.Entity<Region>().HasData(Regions().OrderBy(d => d.Name, StringComparer.OrdinalIgnoreCase));
        modelBuilder.Entity<District>().HasData(Districts().OrderBy(r => r.Name, StringComparer.OrdinalIgnoreCase));
        modelBuilder.Entity<SubDistrict>().HasData(SubDistricts().OrderBy(sd => sd.Name, StringComparer.OrdinalIgnoreCase));
    }
